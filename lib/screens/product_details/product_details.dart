...
// import 'package:cosmatic/screens/checkout_screen/checkout_screen.dart';
...
//     feedbacks = await FirebaseFirestoreHelper.instance.getProductFeedback(widget.singleProduct.id);
//     setState(() {});
//   }
...
//                               style: TextStyle(fontSize: 20, color: AppColor.primaryColor, fontWeight: FontWeight.w500),
//                             ),
//                           ],
//                         ),
//                         Column(
...
//                       const Text("Customer Feedback", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
//                       const SizedBox(height: 10),
//                       CarouselSlider(
...
//                             onPressed: () {
//                               ProductModel productModel = widget.singleProduct.copyWith(quantity: quantity);
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            GestureDetector(
                              ...
                              onTap: () {
                                ...
                                if (widget.singleProduct.isFav) {
                                  ...
                                  appProvider
                                      .removeFromFav(widget.singleProduct);
                                  showMessage("Removed from Favourites");
                                }
                              },
                            ),
                    ...
                    Text(
                      ...
                      textAlign: TextAlign.justify,
                      style: TextStyle(
                          fontSize: 15, color: AppColor.subTitleColor),
                    ),
                    const SizedBox(height: 15),
                    Row(
                      children: [
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ProductModel productModel = widget.singleProduct
                                .copyWith(quantity: quantity);
                            double totalPrice =
                                double.parse(productModel.price) * quantity;
                            Navigator.push(
                              context,
                              MaterialPageRoute(
